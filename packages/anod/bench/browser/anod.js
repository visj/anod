...
function p(t, i) {
	this.j = 0 | i, this.N = t, this.u = 0, this.O = null, this.P = 0, this.T = null;
}
...
{
	let t = s.prototype, i = p.prototype, l = x.prototype, n = z.prototype, e = Ft.prototype;
	i.st = 0, t.K = null, t.$ = -1, t.dispose = i.dispose = l.dispose = n.dispose = function() {
		8 & this.j || (ri ? this.S() : ui[fi++] = this);
	}, l.yt = n.yt = function(t) {
		let i = bl, l = t.u;
		t.u = i, l !== i - 1 ? (l > ii && (ni[li++] = t, ni[li++] = l), 64 & this.j ? Li(this, t) : null === this.q ? (this.q = [t, 0], this.j &= -4097) : this.q.push(t, 0)) : ei++;
		...
		return 1 & dl && bl !== this.u && pl.yt(this), this.N;
	}, i.set = function(t) {
		...
		if (1 & dl && bl !== this.u && pl.yt(this), 512 & this.j) throw this.N;
		return this.N;
	}, l.set = function(t) {
		...
		if (pl = this, 2048 == (2112 & i)) {
			...
			64 & i ? (s = Pi, Pi = Ni) : (e = ei, ei = 0, u = al(n - 1, this.W, this.q), f = null !== this.q ? this.q.length : 0);
			try {
		...
		if (pl = this, 2048 == (2112 & i)) {
			...
			64 & i ? (h = Pi, Pi = Ni) : (f = ei, ei = 0, o = al(e - 1, this.W, this.q), r = null !== this.q ? this.q.length : 0);
			try {
				l = this.V(this.Y);
			} finally {
...
function dt(t, i) {
	...
	(i !== t.N || 512 & t.j) && (t.N = i, t.st = si + 1, 1048576 & t.j ? null !== t.q && wl(t) : ll(t) && (t.V = t.Y = null), h(t, 1), Et());
}
function wl(t) {
...
function at(t, i, l, n, s) {
	let e, h;
	return "function" == typeof t ? (h = 2112 | (0 | l) & C, e = new x(h, t, null, i, n)) : (h = 22528 | (0 | n) & C, e = new x(h, i, t, l, s), e.D = M(t, e, -1)), 2 & dl && jt(pl, e), 1024 & h || bt(e), e;
}
function yt(t, i, l, n) {
	let s, e, h = 2 & dl ? pl : null;
	if ("function" == typeof t ? (e = 2112 | (0 | i) & 134208, s = new z(e, t, null, h, l)) : (e = 22528 | (0 | l) & 134208, s = new z(e, i, t, h, n), s.D = M(t, s, -1)), h) {
		let t = h.$ + 1;
		h.$ > 2 && t >= pi.length && (pi.push(0), di.push([])), s.$ = t, jt(h, s);
	}
...
function setupDeep() {
	...
	const head = a(0);
	let current = head;
	for (let i = 0; i < len; i++) current = at(current, (v) => {
		counter++;
		return v + 1;
	});
	yt(current, (v) => {
...
function setupBroad() {
	const head = a(0);
	for (let i = 0; i < 50; i++) yt(at(at(head, (v) => {
		counter++;
		return v + i;
	}), (v) => {
		counter++;
...
function setupDiamond() {
	...
	const head = a(0);
	const branches = [];
	for (let i = 0; i < width; i++) branches.push(at(head, (v) => {
		counter++;
		return v + 1;
	}));
	yt(at(() => {
...
function setupMux() {
	...
	const split = heads.map((_, index) => at(mux, (v) => {
		counter++;
		return v[index];
	})).map((x) => at(x, (v) => {
		counter++;
...
function setupUnstable() {
	const head = a(0);
	const double = at(head, (v) => {
		counter++;
		return v * 2;
	});
	const inverse = at(head, (v) => {
		counter++;
		return -v;
	});
	yt(f(() => {
