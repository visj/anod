...
describe("join edge cases", () => {
    ...
    test("null and undefined become empty strings (native behaviour)", () => {
        const l = c.list([1, null, undefined, 2]);
