(function(w) {
	...
	w.anod.value = value;
	w.anod.Flag = Flag;
	w.anod.cleanup = cleanup;
	w.anod.freeze = freeze;
	w.anod.bind = bind;
	w.anod.run = run;
	w.anod.fn = fn;
	w.anod.on = on;
	w.anod.root = root;
	w.anod.sample = sample;
	w.anod.Data = Data;
	w.anod.Value = Value;
	w.anod.Computation = Computation;
	w.anod.Enumerable = Enumerable;
	w.anod.DataArray = DataArray;
	w.anod.DataEnumerable = DataEnumerable;
})(window);