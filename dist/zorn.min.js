...
function r(a){var b=a.g;0===(b&6)&&(a.g|=16,32===(b&160)?x(y,a):x(z,a),null!==a.i&&A(a.i),0!==(b&32)&&q(a))}function A(a){for(var b=a.length,c=0;c<b;c++){var d=a[c];d.g=4;x(B,d);d=d.i;null!==d&&(A(d),d.length=0)}}function C(a){p.call(this,D,0,a);this.i=E}function G(){0===(this.g&6)&&h&&H(this);return this.h}
