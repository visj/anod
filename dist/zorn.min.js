...
t.prototype.s=u;function n(a,b){var c=a.h;0===(c&6)&&a.u<b&&(a.u=b,a.h|=16,32===(c&160)?v(w,a):v(x,a),null!==a.g&&y(a.g,b),0!==(c&32)&&l(a,b))}function y(a,b){for(var c=a.length,d=0;d<c;d++){var e=a[d];e.u=b;e.h=4;v(z,e);e=e.g;null!==e&&(y(e,b),e.length=0)}}function A(a){k.call(this,B,0,a);this.g=C}function D(){0===(this.h&6)&&null!==E&&G(this);return this.i}
...
g(P.prototype,{get:D,set:function(a){0===(this.h&6)&&((void 0===this.j?a===this.i:this.j(a,this.i))||H.call(this,a));return a}});P.prototype.B=N;P.prototype.s=function(){this.j=null;O.call(this)};function Q(a,b,c,d){var e=B,h=E;k.call(this,e,c);this.u=0;this.A=null;this.H=0;this.C=this.j=this.g=this.D=this.o=null;!1===d&&(this.h|=128);this.F=a;B=E=this;if(0===I){J();I=1;try{this.i=a(b),0===M.g&&0===z.g||R()}finally{I=0,B=E=null}}else this.i=a(b);B=e;E=h}
...
function U(a,b){I=a.j;for(var c=0,d=0;d<a.g;d++){var e=a.l[d],h=e.h;if(0!==(h&20))try{0!==(h&16)?e.B(b):e.s(b)}catch(m){c=1,0!==(h&16)&&(e.i=m,e.h|=64)}a.l[d]=null}a.g=0;return c}var C={},K=0,I=0,z=new T(2),M=new T(3),w=new T(4),x=new T(5),B=null,E=null;function J(){z.g=M.g=w.g=x.g=0}
...
function V(a,b){if(0===(a.h&6))if(-1===b)a.m=null;else{var c=a.l;a=a.v;var d=c.pop(),e=a.pop();b!==c.length&&(c[b]=d,a[b]=e,-1===e?d.H=b:d.D[e]=b)}}function q(a,b){if(0===(a.h&6))if(-1===b)a.A=null;else{var c=a.o;a=a.D;var d=c.pop(),e=a.pop();b!==c.length&&(c[b]=d,a[b]=e,-1===e?d.G=b:d.v[e]=b)}}return{root:function(a){var b=new t,c=B,d=E;B=b;E=null;if(0===I)try{b.i=a()}finally{B=c,E=d}else b.i=a(),B=c,E=d;return b},dispose:function(a){var b=a.h;0===(b&6)&&(0===I?a.s(K):(a.h=b&-17|4,v(z,a)))},val:function(a){return new f(a)},compute:function(a,b,c){return new Q(a,b,1,c)},$compute:function(a,b,c){return new Q(a,b,0,c)}
