...
function U(a,b){if(0===(a.h&6))if(-1===b)a.m=null;else{var c=a.l;a=a.v;var d=c.pop(),e=a.pop();b!==c.length&&(c[b]=d,a[b]=e,-1===e?d.H=b:d.D[e]=b)}}function q(a,b){if(0===(a.h&6))if(-1===b)a.A=null;else{var c=a.o;a=a.D;var d=c.pop(),e=a.pop();b!==c.length&&(c[b]=d,a[b]=e,-1===e?d.G=b:d.v[e]=b)}}return{root:function(a){var b=new t,c=A,d=D;A=b;D=null;if(0===H)try{b.i=a()}finally{A=c,D=d}else b.i=a(),A=c,D=d;return b},dispose:function(a){var b=a.h;0===(b&6)&&(0===H?a.s(J):(a.h=b&-17|4,y.add(a)))},val:function(a){return new f(a)},compute:function(a,b,c){return new P(a,b,65,c)},$compute:function(a,b,c){return new P(a,b,64,c)},effect:function(a,b){new P(a,b,1)},$effect:function(a,b){new P(a,b,0)}
