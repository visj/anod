var Zorn = (function() {
	...
	return { root: root, dispose: dispose, val: val, owner: owner, compute: compute, $compute: $compute, when: when, peek: peek, data: data, value: value, nil: nil, freeze: freeze, recover: recover, cleanup: cleanup, Data: Data, Value: Value, Computation: Computation };
})();