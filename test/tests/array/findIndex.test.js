...
test("findIndex", function (t) {
    t.test("behaves like native", function (t) {
        t.test("basic findIndex", function (t) {
            var s1 = array([1, 2, 3, 4, 5]);
            var s2 = s1.findIndex(function (item) {
                return item > 3;
            });
            t.assert(s2.val() === 3);
        });
        ...
        t.test("with index", function (t) {
            var s1 = array(['a', 'b', 'c']);
            var s2 = s1.findIndex(function (item, index) {
                return index === 1;
            });
            t.assert(s2.val() === 1);
        });
    ...
    t.test("edge cases", function (t) {
        t.test("null/undefined values", function (t) {
            ...
            var s3 = s1.findIndex(function (item) {
